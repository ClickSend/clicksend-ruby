...
module ClickSendClient
  class SMSApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [String]
    def sms_receipt_read_by_message_id_put(message_id, opts = {})
      data, _status_code, _headers = sms_receipt_read_by_message_id_put_with_http_info(message_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(String, Fixnum, Hash)>] String data, response status code and response headers
    def sms_receipt_read_by_message_id_put_with_http_info(message_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SMSApi.sms_receipt_read_by_message_id_put ...'
      end
      # verify the required parameter 'message_id' is set
      if @api_client.config.client_side_validation && message_id.nil?
        fail ArgumentError, "Missing the required parameter 'message_id' when calling SMSApi.sms_receipt_read_by_message_id_put"
      end
      # resource path
      local_var_path = '/sms/receipts-read/{message_id}'.sub('{' + 'message_id' + '}', message_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'String')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SMSApi#sms_receipt_read_by_message_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
