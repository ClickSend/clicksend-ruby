...
module ClickSendClient
  class InboundFAXRulesApi
    ...
    # @return [String]
    def fax_inbound_automations_get(q, opts = {})
      data, _status_code, _headers = fax_inbound_automations_get_with_http_info(q, opts)
      data
    end
    ...
    # @return [Array<(String, Fixnum, Hash)>] String data, response status code and response headers
    def fax_inbound_automations_get_with_http_info(q, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InboundFAXRulesApi.fax_inbound_automations_get ...'
      end
      # verify the required parameter 'q' is set
      if @api_client.config.client_side_validation && q.nil?
        fail ArgumentError, "Missing the required parameter 'q' when calling InboundFAXRulesApi.fax_inbound_automations_get"
      end
