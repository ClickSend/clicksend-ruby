...
module ClickSendClient
  class VoiceDeliveryReceiptRulesApi
    ...
    # @return [String]
    def voice_delivery_receipt_automations_get(q, opts = {})
      data, _status_code, _headers = voice_delivery_receipt_automations_get_with_http_info(q, opts)
      data
    end
    ...
    # @return [Array<(String, Fixnum, Hash)>] String data, response status code and response headers
    def voice_delivery_receipt_automations_get_with_http_info(q, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && q.nil?
        fail ArgumentError, "Missing the required parameter 'q' when calling VoiceDeliveryReceiptRulesApi.voice_delivery_receipt_automations_get"
      end
