...
module ClickSendClient
  ...
  class MmsCampaign
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'media_file')
    ...
    def list_invalid_properties
      ...
      if @media_file.nil?
        invalid_properties.push('invalid value for "media_file", media_file cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @media_file.nil?
      true
    end
    ...
    def hash
      [list_id, name, body, from, schedule, subject, media_file].hash
    end
