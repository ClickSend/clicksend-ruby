...
# Unit tests for SwaggerClient::InboundSMSRulesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InboundSMSRulesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::InboundSMSRulesApi.new
  end
  ...
  describe 'test an instance of InboundSMSRulesApi' do
    it 'should create an instance of InboundSMSRulesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::InboundSMSRulesApi)
    end
  end
