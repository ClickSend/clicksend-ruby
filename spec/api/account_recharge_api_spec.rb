...
# Unit tests for SwaggerClient::AccountRechargeApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountRechargeApi' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountRechargeApi.new
  end
  ...
  describe 'test an instance of AccountRechargeApi' do
    it 'should create an instance of AccountRechargeApi' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountRechargeApi)
    end
  end
