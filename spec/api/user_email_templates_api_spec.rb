...
# Unit tests for SwaggerClient::UserEmailTemplatesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserEmailTemplatesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::UserEmailTemplatesApi.new
  end
  ...
  describe 'test an instance of UserEmailTemplatesApi' do
    it 'should create an instance of UserEmailTemplatesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::UserEmailTemplatesApi)
    end
  end
