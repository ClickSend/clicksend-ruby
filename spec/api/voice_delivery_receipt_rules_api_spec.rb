...
# Unit tests for SwaggerClient::VoiceDeliveryReceiptRulesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VoiceDeliveryReceiptRulesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::VoiceDeliveryReceiptRulesApi.new
  end
  ...
  describe 'test an instance of VoiceDeliveryReceiptRulesApi' do
    it 'should create an instance of VoiceDeliveryReceiptRulesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::VoiceDeliveryReceiptRulesApi)
    end
  end
