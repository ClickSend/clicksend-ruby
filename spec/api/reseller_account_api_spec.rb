...
# Unit tests for SwaggerClient::ResellerAccountApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResellerAccountApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ResellerAccountApi.new
  end
  ...
  describe 'test an instance of ResellerAccountApi' do
    it 'should create an instance of ResellerAccountApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ResellerAccountApi)
    end
  end
