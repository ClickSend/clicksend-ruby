...
# Unit tests for SwaggerClient::TransactionalEmailApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionalEmailApi' do
  before do
    # run before each test
    @instance = SwaggerClient::TransactionalEmailApi.new
  end
  ...
  describe 'test an instance of TransactionalEmailApi' do
    it 'should create an instance of TransactionalEmailApi' do
      expect(@instance).to be_instance_of(SwaggerClient::TransactionalEmailApi)
    end
  end
