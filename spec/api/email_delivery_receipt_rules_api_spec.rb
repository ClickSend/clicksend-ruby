...
# Unit tests for ClickSendClient::EmailDeliveryReceiptRulesApi
...
describe 'EmailDeliveryReceiptRulesApi' do
  before do
    ...
    @instance = ClickSendClient::EmailDeliveryReceiptRulesApi.new
  end
  ...
  describe 'test an instance of EmailDeliveryReceiptRulesApi' do
    it 'should create an instance of EmailDeliveryReceiptRulesApi' do
      expect(@instance).to be_instance_of(ClickSendClient::EmailDeliveryReceiptRulesApi)
    end
  end
