...
# Unit tests for SwaggerClient::MmsMessageCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MmsMessageCollection' do
  before do
    # run before each test
    @instance = SwaggerClient::MmsMessageCollection.new
  end
  ...
  describe 'test an instance of MmsMessageCollection' do
    it 'should create an instance of MmsMessageCollection' do
      expect(@instance).to be_instance_of(SwaggerClient::MmsMessageCollection)
    end
  end
