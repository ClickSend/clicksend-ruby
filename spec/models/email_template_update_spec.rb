...
# Unit tests for SwaggerClient::EmailTemplateUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailTemplateUpdate' do
  before do
    # run before each test
    @instance = SwaggerClient::EmailTemplateUpdate.new
  end
  ...
  describe 'test an instance of EmailTemplateUpdate' do
    it 'should create an instance of EmailTemplateUpdate' do
      expect(@instance).to be_instance_of(SwaggerClient::EmailTemplateUpdate)
    end
  end
